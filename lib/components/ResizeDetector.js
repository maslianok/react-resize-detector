...
function (_PureComponent) {
  ...
  function ResizeDetector(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleObserver", function (isOn) {
      ...
      var handle = _this.resizeObserver[type];
    ...
    var _handle = (0, _utils.getHandle)(refreshMode);

    _this.resizeHandler = _handle ? _handle(_this.createResizeHandler, refreshRate, refreshOptions) : _this.createResizeHandler;
