...
var createAsyncNotifier = function createAsyncNotifier(onResize, setSize) {
  return (// eslint-disable-next-line implicit-arrow-linebreak
    (0, _rafSchd["default"])(function (_ref) {
...
function useResizeDetector() {
  ...
  var skipResize = (0, _react.useRef)(null);
  var ref = (0, _react.useRef)(null);
  var resizeHandler = (0, _react.useRef)(null);
  var onResizeCallback = (0, _react.useRef)(onResize);
  ...
  (0, _react.useEffect)(function () {
    ...
    var createResizeHandler = function createResizeHandler(entries) {
      ...
      entries.forEach(function (entry) {
        ...
        var shouldSetSize = !skipResize.current && !(0, _utils.isSSR)();
...
var _default = useResizeDetector;
